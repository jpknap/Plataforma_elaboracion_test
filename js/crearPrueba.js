...
function generarPrueba(){
	...
	$.post('php/prueba.php',{operacion:0,dat1:localStorage.idUser,dat2:titulo,dat3:descripcion,dat4:JSON.stringify(listaTags),dat5:JSON.stringify(listaPreguntas) },procesarLecturaXML,'json');
}
